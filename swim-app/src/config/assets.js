const ASSETS = [
  ...
  // AI-generated painterly ground textures for the Scene Composer swapper.
  { id: 'groundTextureMeadow', type: 'texture', path: ['/textures/ground/ground_meadow.png'] },
  { id: 'groundTextureSakura', type: 'texture', path: ['/textures/ground/ground_sakura.png'] },
  { id: 'groundTextureForest', type: 'texture', path: ['/textures/ground/ground_forest.png'] },
  { id: 'groundTextureWheat', type: 'texture', path: ['/textures/ground/ground_wheat.png'] },
  { id: 'groundTextureShore', type: 'texture', path: ['/textures/ground/ground_shore.png'] },
  { id: 'groundTextureMoondustBeach', type: 'texture', path: ['/textures/ground/ground_moondust_beach_soil_granular.png'] },
  { id: 'groundTextureAlienPavement', type: 'texture', path: ['/textures/ground/ground_alien_pavement_soil_granular.png'] },
  { id: 'groundTextureSanctuaryRock', type: 'texture', path: ['/textures/ground/ground_sanctuary_rock_soil_granular.png'] },
  { id: 'groundTextureStarfallPlain', type: 'texture', path: ['/textures/ground/ground_starfall_plain_soil_granular.png'] },
  {
    id: 'tentModel',
    type: 'gltfModelCompressed',
  ...
  // ── "Go for a Swim" pool world — custom AI-generated props + tile texture ──
  { id: 'poolMosaicTexture', type: 'texture', path: ['/textures/pool/mosaic.png'] },
  { id: 'poolChairModel', type: 'gltfModelCompressed', path: ['/models/pool/chair.glb'] },
  { id: 'poolParasolModel', type: 'gltfModelCompressed', path: ['/models/pool/parasol.glb'] },
  { id: 'poolPalmModel', type: 'gltfModelCompressed', path: ['/models/pool/palm.glb'] },
  { id: 'poolCocktailModel', type: 'gltfModelCompressed', path: ['/models/pool/cocktail.glb'] },
  { id: 'poolFlamingoModel', type: 'gltfModelCompressed', path: ['/models/pool/flamingo.glb'] },
  { id: 'starLakeModel', type: 'gltfModelCompressed', path: ['/models/pool/star-lake.glb'] },
  // Paper characters (composited avatar layers) floating in the pool. These are
  // test stand-ins; live builds come from the character creator (Supabase).
  { id: 'poolSwimmer1Texture', type: 'texture', path: ['/textures/pool/swimmer1.png'] },
  { id: 'poolSwimmer2Texture', type: 'texture', path: ['/textures/pool/swimmer2.png'] },
];
