...
export default class EnvironmentTimeManager extends EventEmitter {
  constructor(initialTime = null) {
    ...
    // "Go for a Swim" opens in bright daylight (the sunny pool default);
    // visitors can still toggle to the night look. Was clock-driven upstream.
    this._envTime = initialTime ?? 'day';
  }
