...
export class GrassManager {
  ...
  createAllGrassInSingleMesh() {
    ...
    this.grassInstancedMesh.visible = this.baseLayerVisible;
  ...
  createFlowersWithAtlas(atlasTexture) {
    ...
    this.flowerInstancedMesh.visible = this.baseLayerVisible;
