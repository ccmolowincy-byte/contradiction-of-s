...
(function () {
  ...
  var DESTINATIONS = [
    ...
    { href: 'garden.html', label: 'The Garden', short: 'Garden' },
    { href: 'swim/',       label: 'The Water',  short: 'Water' }
  ];
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '  padding:4px;border:1px solid rgba(200,182,224,.16);border-radius:999px;',
      '  background:linear-gradient(135deg,rgba(20,16,30,.58),rgba(10,8,18,.44));',
      '  backdrop-filter:blur(16px) saturate(1.25);-webkit-backdrop-filter:blur(16px) saturate(1.25);',
      '  box-shadow:0 8px 26px rgba(0,0,0,.38),inset 0 1px 0 rgba(255,255,255,.09);}',
      '.cos-nav--top .cos-nav-item{height:30px;display:flex;align-items:center;justify-content:center;border-radius:999px;',
      '  padding:0 16px;color:rgba(228,222,238,.60);font-size:10px;font-weight:500;letter-spacing:.17em;text-transform:uppercase;',
      '  white-space:nowrap;transition:background .18s ease,color .18s ease,box-shadow .18s ease;}',
      '.cos-nav--top .cos-nav-item:hover{color:#fff;background:rgba(255,255,255,.07);}',
      '.cos-nav--top .cos-nav-item.is-active{color:#fff;background:rgba(150,120,196,.24);',
      '  box-shadow:0 0 16px rgba(150,120,205,.28),inset 0 1px 0 rgba(255,255,255,.14);}',
